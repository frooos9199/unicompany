...
import { FiMapPin, FiClock, FiBriefcase, FiArrowRight, FiArrowLeft } from 'react-icons/fi';
            ...
            <Card>
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="min-w-0">
                  <h3 className="font-semibold text-[var(--foreground)] text-sm sm:text-base truncate">{job.title}</h3>
